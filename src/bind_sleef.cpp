...
std::unordered_map<std::string, multi_eval_func<float>> funs_fx1 = {
    {"sin_pi", scalar_func_map<float>([](float x) -> float { return Sleef_sinpif1_u05purecfma(x); })},
    {"cos_pi", scalar_func_map<float>([](float x) -> float { return Sleef_cospif1_u05purecfma(x); })},
    {"sin", scalar_func_map<float>([](float x) -> float { return Sleef_sinf1_u10purecfma(x); })},
    {"cos", scalar_func_map<float>([](float x) -> float { return Sleef_cosf1_u10purecfma(x); })},
    {"tan", scalar_func_map<float>([](float x) -> float { return Sleef_tanf1_u10purecfma(x); })},
    {"sinh", scalar_func_map<float>([](float x) -> float { return Sleef_sinhf1_u10purecfma(x); })},
    {"cosh", scalar_func_map<float>([](float x) -> float { return Sleef_coshf1_u10purecfma(x); })},
    {"tanh", scalar_func_map<float>([](float x) -> float { return Sleef_tanhf1_u10purecfma(x); })},
    {"asin", scalar_func_map<float>([](float x) -> float { return Sleef_asinf1_u10purecfma(x); })},
    {"acos", scalar_func_map<float>([](float x) -> float { return Sleef_acosf1_u10purecfma(x); })},
    {"atan", scalar_func_map<float>([](float x) -> float { return Sleef_atanf1_u10purecfma(x); })},
    {"asinh", scalar_func_map<float>([](float x) -> float { return Sleef_asinhf1_u10purecfma(x); })},
    {"acosh", scalar_func_map<float>([](float x) -> float { return Sleef_acoshf1_u10purecfma(x); })},
    {"atanh", scalar_func_map<float>([](float x) -> float { return Sleef_atanhf1_u10purecfma(x); })},
    {"log", scalar_func_map<float>([](float x) -> float { return Sleef_logf1_u10purecfma(x); })},
    {"log2", scalar_func_map<float>([](float x) -> float { return Sleef_log2f1_u10purecfma(x); })},
    {"log10", scalar_func_map<float>([](float x) -> float { return Sleef_log10f1_u10purecfma(x); })},
    {"exp", scalar_func_map<float>([](float x) -> float { return Sleef_expf1_u10purecfma(x); })},
    {"exp2", scalar_func_map<float>([](float x) -> float { return Sleef_exp2f1_u10purecfma(x); })},
    {"exp10", scalar_func_map<float>([](float x) -> float { return Sleef_exp10f1_u10purecfma(x); })},
    {"erf", scalar_func_map<float>([](float x) -> float { return Sleef_erff1_u10purecfma(x); })},
    {"erfc", scalar_func_map<float>([](float x) -> float { return Sleef_erfcf1_u15purecfma(x); })},
    {"lgamma", scalar_func_map<float>([](float x) -> float { return Sleef_lgammaf1_u10purecfma(x); })},
    {"tgamma", scalar_func_map<float>([](float x) -> float { return Sleef_tgammaf1_u10purecfma(x); })},
    {"sqrt", scalar_func_map<float>([](float x) -> float { return Sleef_sqrtf1_u05purecfma(x); })},
    {"pow3.5", scalar_func_map<float>([](float x) -> float { return Sleef_powf1_u10purecfma(x, 3.5); })},
    {"pow13", scalar_func_map<float>([](float x) -> float { return Sleef_powf1_u10purecfma(x, 13); })},
};

std::unordered_map<std::string, multi_eval_func<double>> funs_dx1 = {
    {"sin_pi", scalar_func_map<double>([](double x) -> double { return Sleef_sinpid1_u05purecfma(x); })},
    {"cos_pi", scalar_func_map<double>([](double x) -> double { return Sleef_cospid1_u05purecfma(x); })},
    {"sin", scalar_func_map<double>([](double x) -> double { return Sleef_sind1_u10purecfma(x); })},
    {"cos", scalar_func_map<double>([](double x) -> double { return Sleef_cosd1_u10purecfma(x); })},
    {"tan", scalar_func_map<double>([](double x) -> double { return Sleef_tand1_u10purecfma(x); })},
    {"sinh", scalar_func_map<double>([](double x) -> double { return Sleef_sinhd1_u10purecfma(x); })},
    {"cosh", scalar_func_map<double>([](double x) -> double { return Sleef_coshd1_u10purecfma(x); })},
    {"tanh", scalar_func_map<double>([](double x) -> double { return Sleef_tanhd1_u10purecfma(x); })},
    {"asin", scalar_func_map<double>([](double x) -> double { return Sleef_asind1_u10purecfma(x); })},
    {"acos", scalar_func_map<double>([](double x) -> double { return Sleef_acosd1_u10purecfma(x); })},
    {"atan", scalar_func_map<double>([](double x) -> double { return Sleef_atand1_u10purecfma(x); })},
    {"asinh", scalar_func_map<double>([](double x) -> double { return Sleef_asinhd1_u10purecfma(x); })},
    {"acosh", scalar_func_map<double>([](double x) -> double { return Sleef_acoshd1_u10purecfma(x); })},
    {"atanh", scalar_func_map<double>([](double x) -> double { return Sleef_atanhd1_u10purecfma(x); })},
    {"log", scalar_func_map<double>([](double x) -> double { return Sleef_logd1_u10purecfma(x); })},
    {"log2", scalar_func_map<double>([](double x) -> double { return Sleef_log2d1_u10purecfma(x); })},
    {"log10", scalar_func_map<double>([](double x) -> double { return Sleef_log10d1_u10purecfma(x); })},
    {"exp", scalar_func_map<double>([](double x) -> double { return Sleef_expd1_u10purecfma(x); })},
    {"exp2", scalar_func_map<double>([](double x) -> double { return Sleef_exp2d1_u10purecfma(x); })},
    {"exp10", scalar_func_map<double>([](double x) -> double { return Sleef_exp10d1_u10purecfma(x); })},
    {"erf", scalar_func_map<double>([](double x) -> double { return Sleef_erfd1_u10purecfma(x); })},
    {"erfc", scalar_func_map<double>([](double x) -> double { return Sleef_erfcd1_u15purecfma(x); })},
    {"lgamma", scalar_func_map<double>([](double x) -> double { return Sleef_lgammad1_u10purecfma(x); })},
    {"tgamma", scalar_func_map<double>([](double x) -> double { return Sleef_tgammad1_u10purecfma(x); })},
    {"sqrt", scalar_func_map<double>([](double x) -> double { return Sleef_sqrtd1_u05purecfma(x); })},
    {"pow3.5", scalar_func_map<double>([](double x) -> double { return Sleef_powd1_u10purecfma(x, 3.5); })},
    {"pow13", scalar_func_map<double>([](double x) -> double { return Sleef_powd1_u10purecfma(x, 13); })},
};
