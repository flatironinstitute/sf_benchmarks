...
void load_functions() {
    ...
    funs_fx1 = {
        {"sin", scalar_func_map<float>([](float x) -> float { return amd_sinf(x); })},
        {"cos", scalar_func_map<float>([](float x) -> float { return amd_cosf(x); })},
        {"tan", scalar_func_map<float>([](float x) -> float { return amd_tanf(x); })},
        {"sinh", scalar_func_map<float>([](float x) -> float { return amd_sinhf(x); })},
        {"cosh", scalar_func_map<float>([](float x) -> float { return amd_coshf(x); })},
        {"tanh", scalar_func_map<float>([](float x) -> float { return amd_tanhf(x); })},
        {"asin", scalar_func_map<float>([](float x) -> float { return amd_asinf(x); })},
        {"acos", scalar_func_map<float>([](float x) -> float { return amd_acosf(x); })},
        {"atan", scalar_func_map<float>([](float x) -> float { return amd_atanf(x); })},
        {"asinh", scalar_func_map<float>([](float x) -> float { return amd_asinhf(x); })},
        {"acosh", scalar_func_map<float>([](float x) -> float { return amd_acoshf(x); })},
        {"atanh", scalar_func_map<float>([](float x) -> float { return amd_atanhf(x); })},
        {"log", scalar_func_map<float>([](float x) -> float { return amd_logf(x); })},
        {"log2", scalar_func_map<float>([](float x) -> float { return amd_log2f(x); })},
        {"log10", scalar_func_map<float>([](float x) -> float { return amd_log10f(x); })},
        {"exp", scalar_func_map<float>([](float x) -> float { return amd_expf(x); })},
        {"exp2", scalar_func_map<float>([](float x) -> float { return amd_exp2f(x); })},
        {"exp10", scalar_func_map<float>([](float x) -> float { return amd_exp10f(x); })},
        {"sqrt", scalar_func_map<float>([](float x) -> float { return amd_sqrtf(x); })},
        {"pow3.5", scalar_func_map<float>([](float x) -> float { return amd_powf(x, 3.5); })},
        {"pow13", scalar_func_map<float>([](float x) -> float { return amd_powf(x, 13); })},
    };

    funs_dx1 = {
        {"sin", scalar_func_map<double>([](double x) -> double { return amd_sin(x); })},
        {"cos", scalar_func_map<double>([](double x) -> double { return amd_cos(x); })},
        {"tan", scalar_func_map<double>([](double x) -> double { return amd_tan(x); })},
        {"sinh", scalar_func_map<double>([](double x) -> double { return amd_sinh(x); })},
        {"cosh", scalar_func_map<double>([](double x) -> double { return amd_cosh(x); })},
        {"tanh", scalar_func_map<double>([](double x) -> double { return amd_tanh(x); })},
        {"asin", scalar_func_map<double>([](double x) -> double { return amd_asin(x); })},
        {"acos", scalar_func_map<double>([](double x) -> double { return amd_acos(x); })},
        {"atan", scalar_func_map<double>([](double x) -> double { return amd_atan(x); })},
        {"asinh", scalar_func_map<double>([](double x) -> double { return amd_asinh(x); })},
        {"acosh", scalar_func_map<double>([](double x) -> double { return amd_acosh(x); })},
        {"atanh", scalar_func_map<double>([](double x) -> double { return amd_atanh(x); })},
        {"log", scalar_func_map<double>([](double x) -> double { return amd_log(x); })},
        {"log2", scalar_func_map<double>([](double x) -> double { return amd_log2(x); })},
        {"log10", scalar_func_map<double>([](double x) -> double { return amd_log10(x); })},
        {"exp", scalar_func_map<double>([](double x) -> double { return amd_exp(x); })},
        {"exp2", scalar_func_map<double>([](double x) -> double { return amd_exp2(x); })},
        {"exp10", scalar_func_map<double>([](double x) -> double { return amd_exp10(x); })},
        {"sqrt", scalar_func_map<double>([](double x) -> double { return amd_sqrt(x); })},
        {"pow3.5", scalar_func_map<double>([](double x) -> double { return amd_pow(x, 3.5); })},
        {"pow13", scalar_func_map<double>([](double x) -> double { return amd_pow(x, 13); })},
    };
